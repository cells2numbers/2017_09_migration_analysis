...
aggregated <-
  cytominer::aggregate(
    ...
    strata =  strata #c('Metadata_attractant','Metadata_concentration','Metadata_condition','Metadata_dose','Metadata_id')
  ) 
```
...
aggregated %>% 
  ggplot() +
  aes(x = Track_Speed, y = Track_xFMI, shape = Metadata_concentration, color = Metadata_condition) + 
  geom_point() + 
