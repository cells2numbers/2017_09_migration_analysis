...
h1 <- plot.windrose(spd = FN_p$Track_Speed, dir = (180 * (FN_p$Track_Angle) / pi), 
  spdmin = spdmin, spdmax = spdmax, spdres = spdres, dirres = dirres, title_name = "HEM / Prednisolone ")

h2 <- plot.windrose(spd = FN_c$Track_Speed, dir = (180 * (FN_c$Track_Angle) / pi), 
  spdmin = spdmin, spdmax = spdmax, spdres = spdres, dirres = dirres, title_name = "HEM / control")
